...
if user_qualification == 1:
    ...
    "- :grey-background[so you 'll get a better bargain] → Implicit Meaning (e.g. Logical Reasoning)\n" \
    "- :grey-background[as you pack] → Implicit Meaning (e.g. Context)\n" \
    ...
    "- :grey-background[to grip the handlebars too tightly] → Implicit Meaning (e.g. Context)")
